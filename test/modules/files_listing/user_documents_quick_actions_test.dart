    ...
    group('For user documents', () {
      ...
      group('In case of file', () {
        test(
          ...
          expect(tempResult.contains(FileListingQuickActionOptions.expiresOn),
              true);
        ...
        test(
            'When file multiple files are selected common options should be displayed', () {
          Map<String,
              List<JPQuickActionModel>> result = FileListingQuickActionsList
              .getUserDocumentsActionsList(
              FilesListingQuickActionParams(
          ...
          expect(tempResult.contains(FileListingQuickActionOptions.expiresOn),
              false);
          expect(
              tempResult.contains(FileListingQuickActionOptions.info), false);
          expect(
              tempResult.contains(FileListingQuickActionOptions.print), false);
        });
