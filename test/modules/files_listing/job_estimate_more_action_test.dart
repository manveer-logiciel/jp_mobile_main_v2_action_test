...
void main(){
  ...
  group('More actions list when view unit cost permission is given', (){
    
    test('Contains insurance option', (){
      ...
      expect(tempResult.contains(FileListingQuickActionOptions.insurance), true);
    });

  });

  group('More actions list when view unit cost permission is not given', (){
    test('Not contains insurance option', (){
      PermissionService.permissionList = [PermissionConstants.viewResourceViewer];
      Map<String, List<JPQuickActionModel>> results = FileListingMoreActionsList.getActions(
        CreateFileActions(
          fileList: [],
          type: FLModule.estimate, 
      ...
      final tempResult = results[FileListingMoreActionsList.fileActions]!;
      expect(tempResult.contains(FileListingQuickActionOptions.insurance), false);
    });
