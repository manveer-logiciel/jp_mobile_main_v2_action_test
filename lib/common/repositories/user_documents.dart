...
class UserDocumentsRepository {
  static Future<Map<String, dynamic>> fetchFiles(
    ...
    try {
      ...
      {dataToReturn['list'].add(FilesListingModel.fromUserDocumentsJson(task))});
  ...
  static Future<FilesListingModel> createDirectory(
    ...
    try {
      ...
      // Converting api data to model
      return FilesListingModel.fromUserDocumentsJson(jsonData["resources"]);
    } catch (e) {
      //Handle error
      rethrow;
    }
  ...
  static Future<FilesListingModel> renameResource(
    ...
    try {
      ...
      // Converting api data to model
      return FilesListingModel.fromUserDocumentsJson(jsonData["resource"]);
    } catch (e) {
      //Handle error
      rethrow;
    }
