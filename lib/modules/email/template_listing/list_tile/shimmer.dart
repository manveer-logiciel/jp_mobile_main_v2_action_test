...
class EmailTemplateListShimmer extends StatelessWidget {
  const EmailTemplateListShimmer({super.key});
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Row(
                            children: [
                              JPIcon(Icons.remove_red_eye_outlined, size: 24),
                              SizedBox(width: 20),
                              JPIcon(Icons.grade_outlined, size: 24),
                            ]
                          ),
