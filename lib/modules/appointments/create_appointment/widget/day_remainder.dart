...
class AppointmentFormDayReminderSection extends StatelessWidget {
  const AppointmentFormDayReminderSection({
    super.key,
                            ...
                            Visibility(
                              ...
                              child: JPButton(
                                onPressed: () => service.openTimePicker(
                                  datePickerType: DatePickerType.start, initialTime: service.startDateTime
                                ),
                                disabled: !service.isFieldEditable(),
                                size: JPButtonSize.datePickerButton,
                                colorType: JPButtonColorType.lightGray,
