...
import 'package:jobprogress/modules/follow_ups_notes/list_tile/index.dart';
import 'package:jobprogress/modules/job/job_summary/secondary_drawer/job_drawer_item_lists.dart';
import 'package:jp_mobile_flutter_ui/jp_mobile_flutter_ui.dart';
import 'controller.dart';

class FollowUpsNoteListingView  extends StatelessWidget{
  const FollowUpsNoteListingView ({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(FollowUpsNotesListingController());
    return GetBuilder<FollowUpsNotesListingController>(
      ...
      builder: (controller) => JPScaffold(
        ...
        floatingActionButton: controller.job == null || controller.isLoading ? null : JPButton(
          ...
          onPressed: () => controller.openAddEditFollowUpDialogBox(),
        ),
        body: JPSafeArea(
        child: FollowUpsNotesListing(
