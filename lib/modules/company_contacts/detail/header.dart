...
class CompanyContactsHeader extends SliverPersistentHeaderDelegate {
  ...
  double currentRowIconTop(double shrinkOffset) {
    ...
    return GetBuilder<CompanyContactViewController>(builder: (_) {
      Color avatarColor = contactsController.avatarColor;
          ...
          children: [
            ...
            Positioned(
              ...
              child: Material(
                ...
                child: IconButton(
                  splashRadius: 20,
                  onPressed: () {
                    contactsController.scaffoldKey.currentState!.openEndDrawer();
                  },
                  icon: JPIcon(
                    Icons.menu,
                    color: JPAppTheme.themeColors.text,
            ...
            Positioned(
                ...
                child: JPAvatar(
                  ...
                  child: JPText(
                    ...
                    text: contactsController.firstLetterOfName,
            ...
            Positioned(
                ...
                child: SizedBox(
                  ...
                  child: Center(
                    child: JPText(
                      text: contactsController.fullName.capitalize ?? '',
            ...
            Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                      onTap: () {
                        Helper.launchUrl("tel://${contactsController.primeNumber.trim()}");
                      },
                      child: Container(
                        height: 42,
                        width: 42,
                    ...
                    Container(
                      ...
                      child: JPSaveMessageLog(
                        phone: contactsController.primeNumber.trim(),
                        isLargeIcon: true,
                        phoneModel: contactsController.primePhone,
                    ...
                    JPEmailButton(
                      ...
                      email: contactsController.email,
