...
class WorksheetAddItemTaxField extends StatelessWidget {

  const WorksheetAddItemTaxField({
    super.key,
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: JPInputBox(
              inputBoxController: service.taxPercentController,
              label: 'tax_percent'.tr,
              type: JPInputBoxType.withLabel,
              fillColor: JPAppTheme.themeColors.base,
              keyboardType: keyboardType,
              inputFormatters: [inputFormatter],
              prefixChild: const Center(child: JPIcon(Icons.percent, size: 16,)),
              disabled: service.conditionsService.disableTax,
              onChanged: (val) => service.onPercentChange(val, forTax: true),
              maxLength: 9,
            ),
          ),
          Container(
          ...
          Expanded(
            child: JPInputBox(
              inputBoxController: service.taxAmountController,
              label: 'tax_amount'.tr,
              type: JPInputBoxType.withLabel,
              fillColor: JPAppTheme.themeColors.base,
              maxLength: 9,
              ...
              inputFormatters: [inputFormatter],
              disabled: service.conditionsService.disableTax,
              onChanged: (val) => service.onAmountChange(val, forTax: true),
            ),
          ),
        ],
      ),
