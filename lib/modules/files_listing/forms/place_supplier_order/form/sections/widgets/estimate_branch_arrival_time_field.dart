...
class EstimateBranchArrivalTimeField extends StatelessWidget {
  const EstimateBranchArrivalTimeField({super.key, required this.controller, required this.field});
  ...
  Widget build(BuildContext context) {
    return JPInputBox(
      inputBoxController: service.estimateBranchArrivalTimeController,
      type: JPInputBoxType.withLabel,
      label: field.name,
      fillColor: JPAppTheme.themeColors.base,
      isRequired: field.isRequired,
      onPressed: service.selectEstimateBranchArrivalTime,
